        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services" className="text-gray-300 hover:text-white transition-colors text-sm">{t.services}</Link></li>
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              >
                {language === 'en' ? 'NL' : 'EN'} | <span className="font-bold">{language.toUpperCase()}</span>
              </button>
            </div>
          </div>
        </div>
